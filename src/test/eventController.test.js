...
const mockLoc = require('__mock__/location');
...
const mockMapService = {location: {
    create: {

    }
    }};
const save = proxyquire('../controllers/eventController', {
    '../models': mockModels,
    '../services/mapService': mockLoc
});

let result;

const fakeEvent = { dataValues: sinon.stub(), reload: sinon.stub() };
